    ...
    <div className=' min-h-screen flex items-center justify-center bg-slate-200'>
      <div className=' rounded-xl p-4 bg-white flex flex-col gap-2 w-[80%] md:w-[80%] lg:w-1/2'>
        ...
        <div className=' text-start'>
            ...
            <br />
            <input onChange={hanldeChange} className=' p-2 rounded-lg bg-slate-100 text-sm border-none outline-none w-full' type="text" name="fullName" id="" />
        </div>
        <div className=' text-start'>
            <label htmlFor="">Contact</label>
            <br />
            <input onChange={hanldeChange} className=' p-2 rounded-lg bg-slate-100 text-sm border-none outline-none w-full' type="number" name="contact" id="" />
        </div>
        ...
        <div>
            <button onClick={hanldeSignIn} className=' w-full bg-green-600 p-2 rounded-xl text-white'>Register</button>
        </div>
      </div>
    </div>
  )
