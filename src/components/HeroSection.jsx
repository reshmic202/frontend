    ...
    return (
        <section className=' bg-purple-100 lg:px-16 py-3 md:px-8 px-4 lg:min-h-[80vh] flex flex-col lg:flex-row items-center justify-between gap-2'>
            ...
            <div>
                ...
                <p className=' mt-5 mb-10 text-xl font-thin'> Thousands of jobs all the leading sector are waiting for you.</p>

            </div>

            <div className=' bg-white p-2 py-3 rounded-md flex justify-between gap-3 border-grey-300 border-2 shadow-lg '>
                ...
                <div className=' flex items-center gap-2'>
                    <p className=' text-3xl font-thin text-gray-300'>|</p>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
